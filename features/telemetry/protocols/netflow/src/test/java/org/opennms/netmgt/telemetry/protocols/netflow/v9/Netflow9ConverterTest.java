...
package org.opennms.netmgt.telemetry.protocols.netflow.v9;
...
import org.opennms.netmgt.telemetry.protocols.flow.netflow9.proto.Header;
import org.opennms.netmgt.telemetry.protocols.flow.netflow9.proto.Packet;
        ...
        for (byte[] payload : payloads) {
            ...
            try {
                ...
                packet.getRecords().forEach(rec -> {
                    final ByteBuffer bf = PacketHandler.serialize(org.opennms.netmgt.telemetry.protocols.flow.Protocol.NETFLOW9, rec);
