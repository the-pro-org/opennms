...
public class InformationElementDatabase {
    ...
    public static final InformationElementDatabase instance = new InformationElementDatabase(
            new org.opennms.netmgt.telemetry.protocols.flow.ipfix.InformationElementProvider(),
            new org.opennms.netmgt.telemetry.protocols.flow.netflow9.InformationElementProvider());
